...
export const TYPICAL_MASS_FRACTIONS = {
  SOLID: { min: 0.85, max: 0.95, typical: 0.9 },
  LIQUID: { min: 0.8, max: 0.95, typical: 0.88 },
  PRESSURE_FED: { min: 0.75, max: 0.9, typical: 0.82 },
  PUMP_FED: { min: 0.85, max: 0.95, typical: 0.9 },
};
